...
export default function PerfilAdmin() {
  ...
  const handleCambiarContraseña = (e) => {
    e.preventDefault();
    setError('');
    if (passwords.actual !== usuario.contrasena) {
    ...
    const usuarioActualizado = { ...usuario, contrasena: passwords.nueva };
        ...
        <div className="col-md-8">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="mb-3"><strong>Email:</strong> {usuario.email}</div>
              <div className="mb-3"><strong>Teléfono:</strong> {usuario.telefono}</div>
              <div className="mb-3"><strong>Región:</strong> {usuario.region}</div>
              <div className="mb-3"><strong>Comuna:</strong> {usuario.comuna}</div>
